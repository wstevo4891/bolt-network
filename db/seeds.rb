...
Movie.create!(
	...
	fight as a team if they are to stop the mischievous Loki and his 
...
Movie.create!(
	...
	summary: 'Harry, Ron and Hermione search for Voldemort\'s remaining 
	Horcruxes in their effort to destroy the Dark Lord as the final battle 
...
Movie.create!(
	...
	summary: 'When the newly crowned Queen Elsa accidentally uses her 
...
Movie.create!(
	...
	summary: 'When Tony Stark\'s world is torn apart by a formidable 
...
Movie.create!(
	...
	summary: 'The Autobots learn of a Cybertronian spacecraft hidden on 
	the moon, and race against the Decepticons to reach it and to learn 
	its secrets.',
	rating: 35,
	genre_ids: [1, 2]
)
...
Movie.create!(
	...
	summary: 'Gandalf and Aragorn lead the World of Men against Sauron\'s 
...
Movie.create!(
    ...
    summary: 'Bond\'s loyalty to M is tested when her past comes back to 
    haunt her. Whilst MI6 comes under attack, 007 must track down and 
...
Movie.create!(
	...
	summary: 'When the menace known as the Joker wreaks havoc and 
	chaos on the people of Gotham, the caped crusader must come to 
	terms with one of the greatest psychological tests of his ability 
	to fight injustice.',
	rating: 94,
	genre_ids: [1, 5]
)
...
Movie.create!(
	...
	summary: 'Blacksmith Will Turner teams up with eccentric pirate 
	"Captain" Jack Sparrow to save his love, the governor\'s daughter, 
	from Jack\'s former pirate allies, who are now undead.',
	rating: 79,
	genre_ids: [1, 2, 4]
)
...
Movie.create!(
	...
	summary: 'The toys are mistakenly delivered to a day-care center 
